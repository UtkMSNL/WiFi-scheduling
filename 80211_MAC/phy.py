...
import ieee802_11 as gr_ieee802_11
import random
import threading
...
#class receiver_block(grc_wxgui.top_block_gui):
    def __init__(self, options, hostname,msgq):
        ...
        """    
        self.ieee802_1_ofdm_sync_short_0 = gr_ieee802_11.ofdm_sync_short(0.56, 2, False, False)
        self.ieee802_1_ofdm_sync_long_0 = gr_ieee802_11.ofdm_sync_long(sync_length, True, False)
        self.ieee802_1_ofdm_equalize_symbols_0 = gr_ieee802_11.ofdm_equalize_symbols(0, False)
        self.ieee802_1_ofdm_decode_signal_0 = gr_ieee802_11.ofdm_decode_signal(True, False)
        self.ieee802_1_ofdm_decode_mac_0 = gr_ieee802_11.ofdm_decode_mac(True, False)
        self.ieee802_11_ofdm_parse_mac_0 = gr_ieee802_11.ofdm_parse_mac(False, True)
        """ 
	self.ieee802_11_ofdm_sync_short_0 = gr_ieee802_11.ofdm_sync_short(0.56, 2, False, False)
        self.ieee802_11_ofdm_sync_long_0 = gr_ieee802_11.ofdm_sync_long(sync_length, False, False)
        self.ieee802_11_ofdm_parse_mac_0 = gr_ieee802_11.ofdm_parse_mac(False, True)
        self.ieee802_11_ofdm_equalize_symbols_0 = gr_ieee802_11.ofdm_equalize_symbols(0, False)
        self.ieee802_11_ofdm_decode_signal_0 = gr_ieee802_11.ofdm_decode_signal(True, False)
        self.ieee802_11_ofdm_decode_mac_0 = gr_ieee802_11.ofdm_decode_mac(True, False)
        self.ieee802_11_moving_average_xx_1 = gr_ieee802_11.moving_average_ff(window_size + 16)
        self.ieee802_11_moving_average_xx_0 = gr_ieee802_11.moving_average_cc(window_size)
        """
        self.gr_stream_to_vector_0 = blocks.stream_to_vector(gr.sizeof_gr_complex*1, 64)
        self.gr_socket_pdu_0 = blocks.socket_pdu("TCP_CLIENT", hostname, str(options.PHYRXport), 10000)
        self.gr_skiphead_0 = blocks.skiphead(gr.sizeof_gr_complex*1, 20000000)
        self.gr_multiply_xx_0 = blocks.multiply_vcc(1)
        self.gr_divide_xx_0 = blocks.divide_ff(1)
        self.gr_delay_0_0 = blocks.delay(gr.sizeof_gr_complex*1, sync_length)
        self.gr_delay_0 = blocks.delay(gr.sizeof_gr_complex*1, 16)
        self.gr_conjugate_cc_0 = blocks.conjugate_cc()
        self.gr_complex_to_mag_squared_0 = blocks.complex_to_mag_squared(1)
        self.gr_complex_to_mag_0 = blocks.complex_to_mag(1)
	...
	self.fft_vxx_0 = fft.fft_vcc(64, True, (window.rectangular(64)), True, 1)
        ...
        self.connect((self.gr_divide_xx_0, 0), (self.ieee802_1_ofdm_sync_short_0, 2))
        ...
        self.msg_connect(self.ieee802_11_ofdm_parse_mac_0, "fer", self.gr_socket_pdu_0, "pdus")
...
def main():
    ...
    parser.add_option("-f", "--freq", type="eng_float",
                          default = 5.500e9, help="set USRP2 carrier frequency, [default=%default]",
                          metavar="FREQ")
    ...
    parser.add_option("-W", "--bandwidth", type="eng_float", default=2e7, help="set symbol bandwidth [default=%default]\
