...
from ftw_ofdm2 import ftw_transmit_path
...
class wifi_rx(grc_wxgui.top_block_gui):
    ...
    def __init__(self, options, hostname, msgq):
        ...
        self.ieee802_11_ofdm_decode_signal_0 = ieee802_11.ofdm_decode_signal(False, False, True)  #######Added 3rd argument
        self.ieee802_11_ofdm_decode_mac_0 = ieee802_11.ofdm_decode_mac(True, False)	### _reg
        ...
        self.blocks_socket_pdu_0 = blocks.socket_pdu("TCP_CLIENT", hostname, str(options.PHYRXport), 10000)
	...
	###self.msg_connect(self.ieee802_11_ofdm_parse_mac_0, "fer", self.blocks_socket_pdu_0, "pdus")
        ...
        self.msg_connect((self.ieee802_11_ofdm_decode_mac_0, 'out'), (self.blocks_socket_pdu_0, "pdus"))
...
#        return tb.txpath.test_attribute(puerto, eof)
    ...
    parser.add_option("-f", "--freq", type="eng_float",
                          default = 5.87e9, help="set USRP2 carrier frequency, [default=%default]",
                          metavar="FREQ")
    ...
    parser.add_option("-W", "--bandwidth", type="eng_float", default=20e6, help="set symbol bandwidth [default=%default]\
                20 MHz  -> 802.11a/g, OFDM-symbol duration=4us, 10 MHz -> 802.11p, OFDM-symbolduration=8us")
    parser.add_option("-g", "--gain", type="int", default=20 , help = "set USRP2 Rx GAIN in [dB] [default=%default]")
    ...
    parser.add_option("-G", "--txgain", type="int", default=20 , help = "set USRP2 Tx GAIN in [dB] [default=%default]")

    parser.add_option("-n", "--norm", type="eng_float", default=0.4 , help="set gain factor for complex baseband floats [default=%default]")
    ...
    parser.add_option("-l", "--log", action="store_true", default=True, help="write debug-output of individual blocks to disk")
    ...
    while 1:
        ...
        if (arrived_packet["HEADER"]=="PKT"): 
            ...
            t_sendB= time.time()
            send_pkt(item, main_regime, sub_regime,eof=False)   # 'item' is a dictionary which contents the packet to transmit and other information
